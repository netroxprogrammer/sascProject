...
<h2><i class="glyphicon glyphicon-th"></i>Messages From Teachers</h2>
...
<tbody>
  ...
  $timeTable = $database->getDataList("select *from studentnewsupdates where semester='$semester' AND batch='$batch' AND section='$sectionName' "
  ...
  if($timeTable){
    ...
    <tr>
        ...
        <?php }  ?>
        <td><?php echo $timeTableRow['descreption']; ?></td>
