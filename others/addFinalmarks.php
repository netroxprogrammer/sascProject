...
include_once '../libraries/database.php'; 
    ...
    if(isset($_POST['quizMarks'])){
       ...
       $addMarksQuery = "insert into  addquizmarks(program,section,batch,subject,studentId,quizMarks,totalQuizMarks,teacherId,type,semester) "
               . "values('$select_program','$select_section','$select_batch','$select_subject','$studentId','$quizMarks','$quizTotalMarks','$teacherId','final','$smesters')";
...
<div class="box-inner">
<div class="box-header well" data-original-title="">
<h2><i class="glyphicon glyphicon-th"></i>Final Marks</h2>
...
<div class="box-inner">
<div class="box-header well" data-original-title="">
<h2><i class="glyphicon glyphicon-th"></i>Final Total Marks</h2>
