...
<h2><i class="glyphicon glyphicon-th"></i>View My Time Table</h2>
...
<tbody>
  ...
  $timeTable = $database->getDataList("select *from uplaodtimetable where batch='$batch' AND section='$sectionName' AND program='$programId'");
