...
if(isset($_GET['quizid'])){
  ...
  ?>
<script>
window.location="ViewMidMarks.php?id=<?php echo $_SESSION['addId']; ?>";
</script>
<?php
}
?>
...
<tbody>
    ...
    $getQuizDetails = "select *from addquizmarks where studentId='$getstudentId' AND type='mid' AND teacherId='$teacherId'";
         ...
         <?php } ?>
               ...
               <th><?php echo $quizRow['quizMarks']; ?></th> 
                ...
                <td class="center">
                    ...
                    <a href="ViewMidMarks.php?quizid=<?php echo $quizRow['quizId'];  ?>" class="label-default label label-danger">Delete</a></td>
